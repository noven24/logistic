...
import { 
  ...
  Truck, RotateCcw, Eye, Star, Download, Upload, Handshake
} from 'lucide-react';
...
const SistemPeminjamanLogistikKampus = () => {
  ...
  // --- DATA DUMMY ---
  const organizations = [
    { id: 1, name: "BEM Universitas", type: "BEM", members: 150, rating: 4.9 },
    { id: 2, name: "UKM Seni Budaya", type: "UKM", members: 80, rating: 4.7 },
    { id: 3, name: "Himpunan Mahasiswa Teknik", type: "Himpunan", members: 200, rating: 4.8 },
    { id: 4, name: "UKM Olahraga", type: "UKM", members: 120, rating: 4.6 }
  ];
  ...
  const items = [
    ...
    },
    {
      ...
      quantity: 5,
      available: 2,
      description: "Tenda ukuran 4x6 meter dengan kapasitas hingga 30 orang. Dilengkapi dengan dinding samping dan tiang aluminium yang kokoh. Cocok untuk bazaar atau acara outdoor.",
      reviews: 28,
      requirements: [
        "Harus didirikan di permukaan rata",
        "Tidak boleh dipasang saat angin kencang (>30 km/jam)",
        "Harus dilipat dengan rapi saat pengembalian"
      ],
      guarantee: "KTM Asli + Deposit Rp 1.000.000",
      maxDuration: 5,
      specifications: {
        ukuran: "4x6 meter",
        kapasitas: "30 orang",
      ...
      locationDetails: "Gudang UKM Olahraga, Gedung Student Center"
    },
    {
      id: 4,
      name: "Kursi Plastik Standard",
      category: "Furnitur",
      price: 5000,
      originalPrice: null,
      owner: "BEM Universitas",
      ...
      quantity: 100,
      available: 45,
      description: "Kursi plastik standar dengan desain ergonomis. Kapasitas duduk nyaman untuk berbagai acara. Tumpukan rapi untuk penyimpanan efisien.",
      reviews: 67,
      requirements: [
        "Maksimal 2 kursi ditumpuk saat pengembalian",
        "Harus dibersihkan dari debu sebelum dikembalikan"
      ],
      guarantee: "KTM Asli + Deposit Rp 200.000",
      maxDuration: 14,
      specifications: {
        bahan: "Plastik PP",
        kapasitas: "120 kg",
      ...
      maintenanceSchedule: "Pembersihan rutin",
      locationDetails: "Ruang Logistik BEM, Gedung Rektorat Lt. 2"
    }
  ];
  ...
  const bundles = [
    ...
    },
    {
      ...
      image: "🎪",
      bundleItems: [
        { name: "Tenda Besar 4x6m", quantity: 5, available: 2 },
        { name: "Meja Lipat", quantity: 10, available: 12 },
        { name: "Kursi Plastik", quantity: 20, available: 45 },
        { name: "Papan Display", quantity: 5, available: 8 },
        { name: "Lampu Sorot", quantity: 4, available: 6 }
      ],
      status: "Terbatas",
      description: "Paket komplit untuk pameran atau bazaar. Termasuk tenda, meja, kursi, dan lighting. Cocok untuk event 3-5 hari.",
      reviews: 8,
      requirements: [
        "Pemasangan tenda oleh tim berpengalaman",
        "Lampu harus dimatikan saat tidak digunakan",
        "Area harus dibersihkan setelah acara"
      ],
      guarantee: "KTM Asli + Deposit Rp 2.000.000",
      maxDuration: 5,
      savings: 250000,
      popularity: "Medium"
    },
    {
      id: 103,
      name: "Paket Acoustic Performance",
      category: "Bundling",
      price: 250000,
      ...
      image: "🎸",
      bundleItems: [
        { name: "Speaker Acoustic", quantity: 2, available: 4 },
        { name: "Mic Stand", quantity: 2, available: 8 },
        { name: "Audio Mixer", quantity: 1, available: 3 },
        { name: "Kabel Audio", quantity: 4, available: 20 }
      ],
      status: "Tersedia",
      description: "Paket sound system khusus untuk performance acoustic. Sound quality jernih dengan setup yang simpel.",
      reviews: 12,
      requirements: [
        "Sound check minimal 1 jam sebelum acara",
        "Tidak untuk outdoor saat hujan",
        "Volume maksimal 70%"
      ],
      guarantee: "KTM Asli + Deposit Rp 800.000",
      maxDuration: 2,
      savings: 100000,
      popularity: "High"
    }
